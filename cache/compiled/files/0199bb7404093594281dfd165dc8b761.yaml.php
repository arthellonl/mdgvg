...
return [
    ...
    'filename' => '/Applications/MAMP/htdocs/burorood/mdgvg/user/plugins/tinymce-editor/blueprints.yaml',
    'modified' => 1671560212,
    'size' => 3656,
    'data' => [
        ...
        'form' => [
            ...
            'fields' => [
                ...
                'restrictions' => [
                    ...
                    'help' => 'PLUGIN_TINYMCE_EDITOR.RESTRICTIONS_HELP',
                    'default' => [
                        'whitelist' => false,
                        'blacklist' => false
                    ],
                ...
                'whitelist' => [
                    ...
                    'help' => 'PLUGIN_TINYMCE_EDITOR.WHITELIST_HELP',
                    'validate' => [
                        'type' => 'yaml'
                    ]
                ],
                'blacklist' => [
                    ...
                    'help' => 'PLUGIN_TINYMCE_EDITOR.BLACKLIST_HELP',
                    'validate' => [
                        'type' => 'yaml'
                    ]
                ],
