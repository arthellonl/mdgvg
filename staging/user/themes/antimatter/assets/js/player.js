...
(function ($) {
    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" transform="translate()" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                ...
                '<circle class="precache-bar" cx="50" cy="50" r="47.45" stroke="#000000" stroke-opacity="0" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#000000" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="6" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#ffffff" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="40" y1="36" x2="40" y2="64" stroke="#ffffff" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="60" y1="36" x2="60" y2="64" stroke="#ffffff" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
                '<g class="control play">',
                // '<polygon points="45,35 65,50 45,65" fill="#ffffff" stroke-width="0"></polygon>',
                '<path d="M 35,25 10,40 10,10 z" transform="translate(29,25)" fill="#ffffff"  stroke-width="0" />',
                '</g>',
